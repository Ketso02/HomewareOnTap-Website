            ...
            <div class="content-section" id="dashboardSection">
                ...
                <div class="row mb-4 admin-quick-links">
                    <div class="col-lg-3 col-sm-6 mb-3">
                        <a class="admin-card-link" href="<?php echo SITE_URL; ?>/admin/products/manage.php">
                    ...
                    <div class="col-lg-3 col-sm-6 mb-3">
                        <a class="admin-card-link" href="<?php echo SITE_URL; ?>/admin/orders/list.php">
                        <div class="card card-dashboard h-100 position-relative">
                    ...
                    <div class="col-lg-3 col-sm-6 mb-3">
                        <a class="admin-card-link" href="<?php echo SITE_URL; ?>/admin/customers/list.php">
                        <div class="card card-dashboard h-100">
                            <div class="card-body text-center">
                    ...
                    <div class="col-lg-3 col-sm-6 mb-3">
                        <a class="admin-card-link" href="<?php echo SITE_URL; ?>/admin/products/inventory.php">
                        <div class="card card-dashboard h-100 position-relative">
