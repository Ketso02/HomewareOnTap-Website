...
<section class="hero-section position-relative overflow-hidden">
    <div class="container">
        <div class="row align-items-center min-vh-80 py-5">
            <div class="col-lg-6">
                <h2 class="display-4 fw-bold text-dark mb-4">Curated Home Essentials
Designed for Everyday Living</h2>
            ...
            <div class="col-lg-6">
                <div class="hero-image-container">
                    <img src="assets/img/banners/homepage.jpg" alt="Modern Home Decor" class="img-fluid rounded-3 shadow-lg">
                </div>
            </div>
        </div>
    </div>
