...
$already_logged_in = isset($_SESSION['logged_in']) && $_SESSION['logged_in'] === true
    && (isset($_SESSION['user_id']) || isset($_SESSION['user']['id']));
...
// Capture redirect param from URL and store in session (so it survives the page load)
