        ...
        <div class="row g-5">
            <div class="col-lg-8 wow fadeIn" data-wow-delay="0.1s">
                ...
                <div class="mb-5">
                    ...
                    <h4 class="mb-2">Automatically Collected Information</h4>
                ...
                <div class="mb-5">
                    <h3 class="mb-3">4. Sharing Your Information</h3>
                ...
                <div class="mb-5">
                    <h3 class="mb-3">5. Data Retention</h3>
                ...
                <div class="mb-5">
                    <h3 class="mb-3">8. Data Security</h3>
