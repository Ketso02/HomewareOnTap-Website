...
// Checkout delivery and image helper functions
...
function getCheckoutImageUrl($image) {
    if (!empty($image)) {
        ...
        return SITE_URL . '/assets/img/products/primary/' . $image;
    }

    return SITE_URL . '/assets/img/products/primary/default-product.jpg';
}
...
$delivery_method = $_POST['delivery_method'] ?? 'standard_delivery';
$shipping_cost = calculateDeliveryFee($delivery_method);
...
<body>
                        ...
                        <div class="row">
                            <div class="col-lg-8">
                                ...
                                <div class="checkout-section">
                                    ...
                                    <div class="delivery-method <?php echo $delivery_method === 'standard_delivery' ? 'selected' : ''; ?>" onclick="selectDeliveryMethod(this, 'standard_delivery', 80)">
                                        <input type="radio" name="delivery_method" value="standard_delivery" <?php echo $delivery_method === 'standard_delivery' ? 'checked' : ''; ?> style="display: none;">
                                        <div class="d-flex align-items-center">
                                            <div class="delivery-icon">
                                                <img src="<?php echo SITE_URL; ?>/assets/img/checkout/truck.png"
                                                    alt="Standard Delivery"
                                                    width="40">
                                            </div>
                                        <div>
                                                <h5 class="mb-0">Standard Local Delivery - R80</h5>
                                                <p class="mb-0 text-muted">Delivery within our standard Johannesburg delivery area.</p>
                                            </div>
                                        </div>
                                    </div>

                                    <div class="delivery-method <?php echo $delivery_method === 'courier_delivery' ? 'selected' : ''; ?>" onclick="selectDeliveryMethod(this, 'courier_delivery', 150)">
                                        <input type="radio" name="delivery_method" value="courier_delivery" <?php echo $delivery_method === 'courier_delivery' ? 'checked' : ''; ?> style="display: none;">
                                        <div class="d-flex align-items-center">
                                            <div class="delivery-icon">
                                                <img src="<?php echo SITE_URL; ?>/assets/img/checkout/courier.png"
                                                    alt="Courier Delivery"
                                                    width="40">
                                            </div>
                                        <div>
                                                <h5 class="mb-0">Courier Delivery - R150</h5>
                                                <p class="mb-0 text-muted">For areas outside the standard local delivery zone.</p>
                                            </div>
                                        </div>
                                    </div>

                                    <div class="delivery-method <?php echo $delivery_method === 'collection' ? 'selected' : ''; ?>" onclick="selectDeliveryMethod(this, 'collection', 0)">
                                        <input type="radio" name="delivery_method" value="collection" <?php echo $delivery_method === 'collection' ? 'checked' : ''; ?> style="display: none;">
                                        <div class="d-flex align-items-center">
                                            <div class="delivery-icon">
                                                <img src="<?php echo SITE_URL; ?>/assets/img/checkout/collection.png"
                                                    alt="Collection"
                                                    width="40">
                                            </div>
                                        <div>
                                                <h5 class="mb-0">Collect Order - Free</h5>
                                                <p class="mb-0 text-muted">Collect from the arranged HomewareOnTap pickup location.</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="checkout-section">
                                    ...
                                    <div class="payment-method" onclick="selectPaymentMethod(this, 'payfast')">
                                        ...
                                        <div class="d-flex align-items-center">
                                            <img src="<?php echo SITE_URL; ?>/assets/img/checkout/payfast.png" alt="PayFast" class="checkout-logo-wide" onerror="this.style.display='none'">
                                            <div>
                                    ...
                                    <div class="payment-method" onclick="selectPaymentMethod(this, 'credit_card')">
                                        ...
                                        <div class="d-flex align-items-center">
                                            <div class="payment-icons">
                                                <img src="<?php echo SITE_URL; ?>/assets/img/checkout/visa.png" alt="Visa" class="checkout-logo" onerror="this.style.display='none'">
                                                <img src="<?php echo SITE_URL; ?>/assets/img/checkout/mastercard.png" alt="Mastercard" class="checkout-logo" onerror="this.style.display='none'">
                                                <img src="<?php echo SITE_URL; ?>/assets/img/checkout/amex.png" alt="American Express" class="checkout-logo" onerror="this.style.display='none'">
                                            </div>
                                            <div>
                            ...
                            <div class="col-lg-4">
                                <div class="checkout-section">
                                    ...
                                    <div class="order-products">
                                        ...
                                        <div class="cart-product">
                                            <div class="product-thumb">
                                                <?php $itemImageUrl = getCheckoutImageUrl($item['image'] ?? ''); ?>
                                    ...
                                    <div class="order-summary-item">
                                        <span>Delivery <small class="text-muted" id="deliveryMethodLabel">(<?php echo htmlspecialchars(getDeliveryMethodLabel($delivery_method)); ?>)</small></span>
                                        <span id="shippingAmount">R<?php echo number_format($shipping_cost, 2); ?></span>
                                    </div>
                                    
                                    <div class="order-summary-item">
                                        <span>Tax</span>
                                        <span id="taxAmount" data-tax="<?php echo htmlspecialchars($tax_amount); ?>">R<?php echo number_format($tax_amount, 2); ?></span>
                                    </div>
                                    
                                    <div class="order-summary-total">
                                        <span>Total</span>
                                        <span id="grandTotal" data-subtotal="<?php echo htmlspecialchars($cart_total); ?>">R<?php echo number_format($grand_total, 2); ?></span>
                                    </div>
                                    ...
                                    <div class="security-note">
                                        ...
                                        <div class="payment-methods">
                                            <img src="<?php echo SITE_URL; ?>/assets/img/checkout/visa.png" alt="Visa" height="30" class="me-2" onerror="this.style.display='none'">
                                            <img src="<?php echo SITE_URL; ?>/assets/img/checkout/mastercard.png" alt="Mastercard" height="30" class="me-2" onerror="this.style.display='none'">
                                            <img src="<?php echo SITE_URL; ?>/assets/img/checkout/amex.png" alt="American Express" height="30" class="me-2" onerror="this.style.display='none'">
                                            <img src="<?php echo SITE_URL; ?>/assets/img/checkout/payfast.png" alt="PayFast" class="checkout-logo-wide" onerror="this.style.display='none'" height="30">
                                        </div>
                                    </div>
                                </div>
                            </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form id="addAddressForm">
                        <input type="hidden" id="address_type" value="shipping">
                        <div class="row">
                            <div class="col-md-6 mb-3">
    ...
    <script>
        ...
        // Select delivery method and update order totals
        function selectDeliveryMethod(element, method, fee) {
            ...
            const subtotal = parseFloat(document.getElementById('grandTotal').dataset.subtotal || 0);
            const tax = parseFloat(document.getElementById('taxAmount').dataset.tax || 0);
            const total = subtotal + parseFloat(fee) + tax;

            document.getElementById('shippingAmount').textContent = 'R' + parseFloat(fee).toFixed(2);
            document.getElementById('grandTotal').textContent = 'R' + total.toFixed(2);

            let label = 'Standard Local Delivery';
            if (method === 'collection') {
                label = 'Collect Order';
            } else if (method === 'courier_delivery') {
                label = 'Courier Delivery';
            }

            document.getElementById('deliveryMethodLabel').textContent = '(' + label + ')';
        }
    ...
    // Validate required fields
    if (!first_name || !last_name || !street || !city || !province || !postal_code || !country || !phone) {
    ...
    $.ajax({
        ...
        success: function(response) {
            ...
            if (result.success) {
                ...
                showToast('Address saved successfully! Reloading...', 'success');
                setTimeout(() => { location.reload(); }, 1500);
            } else {
                showToast('Error saving address: ' + (result.message || 'Unknown error'), 'error');
