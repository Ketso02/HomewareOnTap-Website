...
// Helper: supports old manual images, new uploaded images, and default fallback
function hwtProductImageUrl($image) {
    if (!empty($image)) {
        // New admin uploaded images are saved like: assets/uploads/products/product_xxx.webp
        if (strpos($image, 'assets/uploads/products/') === 0) {
            return SITE_URL . '/' . $image;
        }

        // Old/manual images are saved as a filename only, like: plate.jpg
        return SITE_URL . '/assets/img/products/primary/' . $image;
    }

    // Fallback image when product image is empty/NULL
...
// Main product image URL used by gallery and thumbnails
$productImage = hwtProductImageUrl($product['image'] ?? '');
                ...
                <div class="col-lg-6">
                    <div class="product-gallery">
                        ...
                        <div class="thumbnails">
                            ...
                            <div class="thumbnail active" data-image="<?php echo htmlspecialchars($productImage); ?>">
                                <img src="<?php echo htmlspecialchars($productImage); ?>"
                        ...
                        <div class="col-md-3 col-sm-6 mb-4">
                            <div class="product-card">
                                <div class="product-image position-relative">
                                    <?php $relatedImage = hwtProductImageUrl($related_product['image'] ?? ''); ?>
