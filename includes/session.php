...
class SessionManager {
    ...
    private function regenerateSession() {
        ...
        // Never regenerate a freshly authenticated session — calling session_regenerate_id(true)
        // destroys the session data set by login-process.php before the redirect target can read it.
        if (!isset($_SESSION['last_regeneration'])) {
            if (!isset($_SESSION['logged_in'])) {
                // Brand-new unauthenticated session — safe to regenerate
